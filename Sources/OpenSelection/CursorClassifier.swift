...
public struct CursorClassifier {
    ...
    /// AppKit state — the cursor *this application* last set — so for a background agent or utility
    /// it reports the default arrow even when the frontmost app shows an I-beam over a text field.
    @MainActor
